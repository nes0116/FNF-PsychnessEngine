...
class ModsMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		conflictWarningText = new FlxText(bgDescription.x + 15, bgDescription.y + bgDescription.height - myHeight - 65, bgDescription.width - 30,
			Language.getPhrase('mod_competition', '* If you play with this mod, it is recommended to disable other mods, as it may conflict with other mods!'),
			16);
