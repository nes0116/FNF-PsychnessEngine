...
class Song
{
	...
	public static function convert(songJson:Dynamic) // Convert old charts to psychness format
	{
		...
		for (section in sectionData)
		{
			...
			if (Reflect.hasField(section, 'mstHitSection'))
